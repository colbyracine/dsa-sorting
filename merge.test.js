...
describe("merge", function () {
  it("should exist", function () {
    expect(typeof merge).toBe(
      "function",
      "did you remember to define the 'merge' function?"
    );
  });
  ...
  it("should be a pure function - in other words, it should not mutate the input arrays", function () {
    ...
    expect(arr1).toEqual(
      [1, 3, 4, 5],
      "The first input array should be unaffected by the merge"
    );
    expect(arr2).toEqual(
      [2, 4, 6, 8],
      "The second input array should be unaffected by the merge"
    );
  });
...
describe("mergeSort", function () {
  it("should exist", function () {
    expect(typeof mergeSort).toBe(
      "function",
      "did you remember to define the 'mergeSort' function?"
    );
  });
